...
import { TextField, Button, Typography, Box, Alert, useMediaQuery, ThemeProvider, createTheme, CircularProgress, InputAdornment, IconButton,
  //  IconButton
   } from '@mui/material';
    ...
    >
      ...
      <Typography 
        ...
        sx={{
          ...
          backgroundClip: 'text', mb:'2rem', mt: '4rem'
        }}
      >
        Login
      </Typography>
