            ...
            {products.map((post) => (
              ...
              >
                ...
                <CardContent sx={{ position: 'absolute',
                  ...
                  <Typography variant="body2" color={post.gender === 'Male' ? '#ffa5a5' : 'rgba(255, 255, 255, 0.9)'} style={{ marginBottom: '0.5rem' }}>
                    Gender: {post.gender}
                  </Typography>
      ...
      UserCode : {post.userCode}
                ...
                <CardActions style={{ justifyContent: 'space-between', padding: '12px 1rem', position: 'absolute',
                  ...
                  {/* <Box> */}
                    ...
                    <Button color="secondary" size="small" variant="outlined" startIcon={<DeleteSweepRoundedIcon />} key={post._id} sx={{borderRadius:'8px'}} onClick={(event) => {event.stopPropagation(); }}>Delete</Button>
