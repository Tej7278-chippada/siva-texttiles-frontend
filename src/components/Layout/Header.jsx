          ...
          <Toolbar sx={{
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', flex: 1 }}>
              <Typography
                ...
                sx={{
                  fontWeight: 700,
                  background: darkMode ?  'linear-gradient(135deg, #4361ee 0%, #3f37c9 100%)' :  `linear-gradient(135deg, ${theme.palette.primary.main} 0%, ${theme.palette.secondary.main} 50%, #ff6f61 100%)`, // 'linear-gradient(135deg, #4361ee 0%, #3f37c9 100%)'
                  backgroundClip: 'text',
